---
title: "scRNAseq IN Neuron Analysis - GSE142535 - J321"
author:
  - name: "Emir Turkes"
...
knit: (function(inputFile, encoding) {
  rmarkdown::render(
    ...
    output_file = file.path("..", "..", "results", unlist(strsplit(getwd(), "/"))[6], "J321.html")
  )})
---
...
```{r}
data <- read.delim(file.path(data_dir, "GSE142535_DropSeqAD.Mylip.digital_expression.txt"))

data <- data[ , grep(sample_name, colnames(data))] # Subset to sample of interest.
