---
title: "scRNAseq IN Neuron Analysis - GSE189033 - D-4"
author:
  - name: "Emir Turkes"
...
knit: (function(inputFile, encoding) {
  rmarkdown::render(
    ...
    output_file = file.path("..", "..", "results", unlist(strsplit(getwd(), "/"))[6], "D-4.html")
  )})
---
...
```{r}
seurat <- readRDS(file.path(data_dir, "GSM5693472_seurat_filtered_analyzed.rds"))
