---
title: "scRNAseq IN Neuron Analysis - Parse vs. 10x Data - IN Proportion"
author:
  - name: "Emir Turkes"
...
knit: (function(inputFile, encoding) {
  rmarkdown::render(
    ...
    output_file = file.path(
      "..", "..", "results", unlist(strsplit(getwd(), "/"))[6], "IN_proportion_parse_10x.html"
  ))})
---
...
sub_files[[1]] <- subset(files[[1]], idents = c("18", "24", "17", "4", "21", "15", "0", "11", "1"))
sub_files[[2]] <- subset(files[[2]], idents = c("16", "9", "20", "8", "21", "4", "23", "0", "25", "12"))
# ---------------------
...
rownames(proportion) <- unlist(strsplit(file_list, split = "/"))[c(1, 3)] # Set rownames as sample names.
...
pvalb[[1]] <- subset(files[[1]], idents = "18")
# ---------------------
