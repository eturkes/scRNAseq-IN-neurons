---
title: "scRNAseq IN Neuron Analysis - GSE214375 - IN Proportion"
author:
  - name: "Emir Turkes"
...
knit: (function(inputFile, encoding) {
  rmarkdown::render(
    ...
    output_file = file.path(
      "..", "..", "results", unlist(strsplit(getwd(), "/"))[6], "IN_proportion_GSE214375.html"
  ))})
---
...
sub_files[[1]] <- subset(files[[1]], idents = c("1", "2", "4"))
sub_files[[2]] <- subset(files[[2]], idents = c("0", "9", "10", "11", "2", "5"))
# ---------------------
