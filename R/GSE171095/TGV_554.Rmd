---
title: "scRNAseq IN Neuron Analysis - GSE171095 - TGV_554"
author:
  - name: "Emir Turkes"
...
knit: (function(inputFile, encoding) {
  rmarkdown::render(
    ...
    output_file = file.path("..", "..", "results", unlist(strsplit(getwd(), "/"))[6], "TGV_554.html")
  )})
---
...
```{r}
data <- read.csv(file.path(data_dir, paste0("GSM6093734_", sample_name, "dr", ".csv"))) # dr = doublets removed.
