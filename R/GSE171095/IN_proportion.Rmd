---
title: "scRNAseq IN Neuron Analysis - GSE171095 - IN Proportion"
author:
  - name: "Emir Turkes"
...
knit: (function(inputFile, encoding) {
  rmarkdown::render(
    ...
    output_file = file.path("..", "..", "results", unlist(strsplit(getwd(), "/"))[6], "IN_proportion.html")
  )})
---
...
sub_files[[1]] <- subset(files[[1]], idents = c("0", "5", "8", "9", "18", "22"))
sub_files[[2]] <- subset(files[[2]], idents = c("0", "1", "7"))
sub_files[[3]] <- subset(files[[3]], idents = c("0", "5", "10", "11"))
sub_files[[4]] <- subset(files[[4]], idents = c("2", "9", "10"))
# ---------------------
...
Plots showing the percentage of IN neurons in each sample.
...
rownames(proportion) <- unlist(strsplit(file_list, split = "/"))[c(1, 3, 5, 7)] # Set rownames as sample names.
