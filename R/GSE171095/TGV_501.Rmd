---
title: "scRNAseq IN Neuron Analysis - GSE171095 - TGV_501"
author:
  - name: "Emir Turkes"
...
knit: (function(inputFile, encoding) {
  rmarkdown::render(
    ...
    output_file = file.path("..", "..", "results", unlist(strsplit(getwd(), "/"))[6], "TGV_501.html")
  )})
---
...
```{r}
data <- read.csv(file.path(data_dir, paste0("GSM6093732_", sample_name, "dr", ".csv"))) # dr = doublets removed.
...
seurat <- cluster_pipeline(
  ...
  vars_to_regress = vars_to_regress, parallel_override = parallel_override, cc = FALSE, res_divider = 20000
)
seurat
