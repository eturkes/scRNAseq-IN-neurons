---
title: "scRNAseq IN Neuron Analysis - GSE140793 - Tg1"
author:
  - name: "Emir Turkes"
...
knit: (function(inputFile, encoding) {
  rmarkdown::render(
    ...
    output_file = file.path("..", "..", "results", unlist(strsplit(getwd(), "/"))[6], "Tg1.html")
  )})
---
...
```{r}
data <- read.delim(file.path(data_dir, "GSM4185172_Tg1.tab"))
...
seurat <- cluster_pipeline(
  ...
  vars_to_regress = vars_to_regress, parallel_override = parallel_override, cc = FALSE, res_divider = 2500
)
seurat
