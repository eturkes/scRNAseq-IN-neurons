---
title: "scRNAseq IN Neuron Analysis - GSE140793 - Tg2"
author:
  - name: "Emir Turkes"
...
knit: (function(inputFile, encoding) {
  rmarkdown::render(
    ...
    output_file = file.path("..", "..", "results", unlist(strsplit(getwd(), "/"))[6], "Tg2.html")
  )})
---
...
```{r}
data <- read.delim(file.path(data_dir, "GSM4185173_Tg2.tab"))
